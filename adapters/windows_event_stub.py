...
def main() -> None:
    parser = argparse.ArgumentParser(description="Normalize Windows event log records (meta-only stub).")
    ...
    parser.add_argument("--source", default="windows_event_stub", help="Provenance source label")
