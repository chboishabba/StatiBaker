...
def normalize_record(record: Dict[str, Any], source: str) -> Dict[str, Any]:
    ...
    author = record.get("author") or record.get("handle")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Normalize social feed records (meta-only).")
    ...
    parser.add_argument("--source", default="social_feed", help="Provenance source label")
