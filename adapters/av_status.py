...
def normalize_record(record: Dict[str, Any], source: str) -> Dict[str, Any]:
    ...
    normalized = {
        ...
        "signature_age_days": record.get("signature_age_days"),
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Normalize AV/endpoint status records (meta-only).")
    ...
    parser.add_argument("--source", default="av_status", help="Provenance source label")
