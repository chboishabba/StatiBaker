...
def normalize_record(record: Dict[str, Any], source: str) -> Dict[str, Any]:
    ...
    author = record.get("from_id") or record.get("author")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Normalize Telegram records (meta-only stub).")
    ...
    parser.add_argument("--source", default="telegram_stub", help="Provenance source label")
